========================================================================
    APLICACIÓN DE CONSOLA: SocketClientTest 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SocketClientTest.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación SocketClientTest.


SocketClientTest.vcxproj
...
SocketClientTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado SocketClientTest.pch y un archivo de tipos 
